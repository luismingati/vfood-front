    ...
    <>
        <div className="flex w-full justify-center font-poppins">
            <div className="w-full flex pl-7 rounded-xl gap-2.5 h-12 bg-searchbarcolor">
                ...
                <input type="text" value={viewModel.search} onChange = {(e) => viewModel.setSearch(e.target.value)} id="default-search" className=" w-full outline-none bg-transparent placeholder-searchbarBlue placeholder:font-normal placeholder:text-base" placeholder="Buscar colaboradores"/>
            </div>
        </div>
    </>
    )
